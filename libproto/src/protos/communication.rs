...
pub enum InnerMessage_oneof_content {
    ...
    BalanceVerifyReq(super::auth::BalanceVerifyReq),
    BalanceVerifyRes(super::auth::BalanceVerifyRes),
}
...
impl InnerMessage {
    ...
    // .BalanceVerifyReq BalanceVerifyReq = 29;

    pub fn clear_BalanceVerifyReq(&mut self) {
        self.content = ::std::option::Option::None;
    }

    pub fn has_BalanceVerifyReq(&self) -> bool {
        match self.content {
            ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyReq(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_BalanceVerifyReq(&mut self, v: super::auth::BalanceVerifyReq) {
        self.content = ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyReq(v))
    }

    // Mutable pointer to the field.
    pub fn mut_BalanceVerifyReq(&mut self) -> &mut super::auth::BalanceVerifyReq {
        if let ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyReq(_)) = self.content {
        } else {
            self.content = ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyReq(super::auth::BalanceVerifyReq::new()));
        }
        match self.content {
            ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyReq(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_BalanceVerifyReq(&mut self) -> super::auth::BalanceVerifyReq {
        if self.has_BalanceVerifyReq() {
            match self.content.take() {
                ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyReq(v)) => v,
                _ => panic!(),
            }
        } else {
            super::auth::BalanceVerifyReq::new()
        }
    }

    pub fn get_BalanceVerifyReq(&self) -> &super::auth::BalanceVerifyReq {
        match self.content {
            ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyReq(ref v)) => v,
            _ => super::auth::BalanceVerifyReq::default_instance(),
        }
    }

    // .BalanceVerifyRes BalanceVerifyRes = 30;

    pub fn clear_BalanceVerifyRes(&mut self) {
        self.content = ::std::option::Option::None;
    }

    pub fn has_BalanceVerifyRes(&self) -> bool {
        match self.content {
            ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyRes(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_BalanceVerifyRes(&mut self, v: super::auth::BalanceVerifyRes) {
        self.content = ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyRes(v))
    }

    // Mutable pointer to the field.
    pub fn mut_BalanceVerifyRes(&mut self) -> &mut super::auth::BalanceVerifyRes {
        if let ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyRes(_)) = self.content {
        } else {
            self.content = ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyRes(super::auth::BalanceVerifyRes::new()));
        }
        match self.content {
            ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyRes(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_BalanceVerifyRes(&mut self) -> super::auth::BalanceVerifyRes {
        if self.has_BalanceVerifyRes() {
            match self.content.take() {
                ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyRes(v)) => v,
                _ => panic!(),
            }
        } else {
            super::auth::BalanceVerifyRes::new()
        }
    }

    pub fn get_BalanceVerifyRes(&self) -> &super::auth::BalanceVerifyRes {
        match self.content {
            ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyRes(ref v)) => v,
            _ => super::auth::BalanceVerifyRes::default_instance(),
        }
    }
}
...
impl ::protobuf::Message for InnerMessage {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(InnerMessage_oneof_content::BalanceVerifyReq(ref v)) = self.content {
            if !v.is_initialized() {
                return false;
            }
        }
        if let Some(InnerMessage_oneof_content::BalanceVerifyRes(ref v)) = self.content {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                29 => {
                    ...
                    self.content = ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyReq(is.read_message()?));
                },
                30 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.content = ::std::option::Option::Some(InnerMessage_oneof_content::BalanceVerifyRes(is.read_message()?));
                },
                _ => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.content {
            match v {
                ...
                &InnerMessage_oneof_content::BalanceVerifyReq(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
                &InnerMessage_oneof_content::BalanceVerifyRes(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
            };
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, super::auth::BalanceVerifyReq>(
                    "BalanceVerifyReq",
                    InnerMessage::has_BalanceVerifyReq,
                    InnerMessage::get_BalanceVerifyReq,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, super::auth::BalanceVerifyRes>(
                    "BalanceVerifyRes",
                    InnerMessage::has_BalanceVerifyRes,
                    InnerMessage::get_BalanceVerifyRes,
                ));
...
impl ::protobuf::Clear for InnerMessage {
    fn clear(&mut self) {
        ...
        self.clear_BalanceVerifyReq();
        self.clear_BalanceVerifyRes();
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    oposal\x12?\n\x10BalanceVerifyReq\x18\x1d\x20\x01(\x0b2\x11.BalanceVerif\
    yReqH\0R\x10BalanceVerifyReq\x12?\n\x10BalanceVerifyRes\x18\x1e\x20\x01(\
    \x0b2\x11.BalanceVerifyResH\0R\x10BalanceVerifyResB\t\n\x07contentJ\xad\
    \r\n\x06\x12\x04\0\0;\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\t\n\x02\x03\
    \0\x12\x03\x02\x07\x16\n\t\n\x02\x03\x01\x12\x03\x03\x07\x17\n\t\n\x02\
    \x03\x02\x12\x03\x04\x07\x13\n\t\n\x02\x03\x03\x12\x03\x05\x07\x19\n\t\n\
    ...
    \x02\x19\x03\x12\x03668\n\x0b\n\x04\x04\0\x02\x1a\x12\x038\x08/\n\x0c\n\
    \x05\x04\0\x02\x1a\x06\x12\x038\x08\x18\n\x0c\n\x05\x04\0\x02\x1a\x01\
    \x12\x038\x19)\n\x0c\n\x05\x04\0\x02\x1a\x03\x12\x038,.\n\x0b\n\x04\x04\
    \0\x02\x1b\x12\x039\x08/\n\x0c\n\x05\x04\0\x02\x1b\x06\x12\x039\x08\x18\
