...
impl ::protobuf::Message for Estimate {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.height.is_empty() {
            my_size += ::protobuf::rt::string_size(5, &self.height);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "from",
                    |m: &Estimate| { &m.from },
                    |m: &mut Estimate| { &mut m.from },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "to",
                    |m: &Estimate| { &m.to },
                    |m: &mut Estimate| { &mut m.to },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "value",
                    |m: &Estimate| { &m.value },
                    |m: &mut Estimate| { &mut m.value },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "data",
                    |m: &Estimate| { &m.data },
                    |m: &mut Estimate| { &mut m.data },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "height",
                    |m: &Estimate| { &m.height },
                    |m: &mut Estimate| { &mut m.height },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<Estimate>(
                    "Estimate",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static Estimate {
        static mut instance: ::protobuf::lazy::Lazy<Estimate> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const Estimate,
        };
        unsafe {
            instance.get(Estimate::new)
        }
    }
}

impl ::protobuf::Clear for Estimate {
    fn clear(&mut self) {
        self.clear_from();
        self.clear_to();
        self.clear_value();
...
impl ::std::fmt::Debug for Estimate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for Estimate {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
impl Request {
    ...
    // Param is passed by value, moved
    pub fn set_estimate_gas(&mut self, v: Estimate) {
        self.req = ::std::option::Option::Some(Request_oneof_req::estimate_gas(v))
    }

    // Mutable pointer to the field.
    pub fn mut_estimate_gas(&mut self) -> &mut Estimate {
        if let ::std::option::Option::Some(Request_oneof_req::estimate_gas(_)) = self.req {
        } else {
            self.req = ::std::option::Option::Some(Request_oneof_req::estimate_gas(Estimate::new()));
        }
        match self.req {
    ...
    // Take field
    pub fn take_estimate_gas(&mut self) -> Estimate {
        if self.has_estimate_gas() {
            match self.req.take() {
                ::std::option::Option::Some(Request_oneof_req::estimate_gas(v)) => v,
                _ => panic!(),
            }
        } else {
            Estimate::new()
    ...
    pub fn get_estimate_gas(&self) -> &Estimate {
        match self.req {
            ::std::option::Option::Some(Request_oneof_req::estimate_gas(ref v)) => v,
            _ => Estimate::default_instance(),
        }
    }
    ...
    pub fn has_gas_price(&self) -> bool {
        match self.req {
            ::std::option::Option::Some(Request_oneof_req::gas_price(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_gas_price(&mut self, v: bool) {
        self.req = ::std::option::Option::Some(Request_oneof_req::gas_price(v))
    }

    pub fn get_gas_price(&self) -> bool {
        match self.req {
            ::std::option::Option::Some(Request_oneof_req::gas_price(v)) => v,
            _ => false,
        }
    }
    ...
    pub fn has_peers(&self) -> bool {
        match self.req {
            ::std::option::Option::Some(Request_oneof_req::peers(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_peers(&mut self, v: bool) {
        self.req = ::std::option::Option::Some(Request_oneof_req::peers(v))
    }

    pub fn get_peers(&self) -> bool {
        match self.req {
            ::std::option::Option::Some(Request_oneof_req::peers(v)) => v,
            _ => false,
        }
    }
    ...
    pub fn has_syncing(&self) -> bool {
        match self.req {
            ::std::option::Option::Some(Request_oneof_req::syncing(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_syncing(&mut self, v: bool) {
        self.req = ::std::option::Option::Some(Request_oneof_req::syncing(v))
    }

    pub fn get_syncing(&self) -> bool {
        match self.req {
            ::std::option::Option::Some(Request_oneof_req::syncing(v)) => v,
            _ => false,
        }
    }

    // string transaction_receipt_ex = 31;
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                27 => {
                    ...
                    self.req = ::std::option::Option::Some(Request_oneof_req::estimate_gas(is.read_message()?));
                },
                28 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.req = ::std::option::Option::Some(Request_oneof_req::gas_price(is.read_bool()?));
                },
                29 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.req = ::std::option::Option::Some(Request_oneof_req::peers(is.read_bool()?));
                },
                30 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.req {
            match v {
                ...
                &Request_oneof_req::estimate_gas(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
                &Request_oneof_req::gas_price(v) => {
                    my_size += 3;
                },
                &Request_oneof_req::peers(v) => {
                    my_size += 3;
                },
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, Estimate>(
                    "estimate_gas",
                    Request::has_estimate_gas,
                    Request::get_estimate_gas,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_bool_accessor::<_>(
                    "gas_price",
                    Request::has_gas_price,
                    Request::get_gas_price,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_bool_accessor::<_>(
                    "peers",
                    Request::has_peers,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x04\x20\x01(\tR\x06height\"p\n\x08Estimate\x12\x12\n\x04from\x18\
    \x01\x20\x01(\x0cR\x04from\x12\x0e\n\x02to\x18\x02\x20\x01(\x0cR\x02to\
    \x12\x14\n\x05value\x18\x03\x20\x01(\x0cR\x05value\x12\x12\n\x04data\x18\
    ...
    ddress\x18\x01\x20\x01(\x0cR\x07address\x12\x1a\n\x08position\x18\x02\
    \x20\x01(\x0cR\x08position\x12\x16\n\x06height\x18\x03\x20\x01(\tR\x06he\
    ...
    \x0b.StorageKeyH\0R\nstorageKey\x12.\n\x0cestimate_gas\x18\x1b\x20\x01(\
    \x0b2\t.EstimateH\0R\x0bestimateGas\x12\x1d\n\tgas_price\x18\x1c\x20\x01\
    (\x08H\0R\x08gasPrice\x12\x16\n\x05peers\x18\x1d\x20\x01(\x08H\0R\x05pee\
    rs\x12\x1a\n\x07syncing\x18\x1e\x20\x01(\x08H\0R\x07syncing\x126\n\x16tr\
    ansaction_receipt_ex\x18\x1f\x20\x01(\tH\0R\x14transactionReceiptExB\x05\
    \n\x03req\"@\n\x0cBatchRequest\x120\n\x0fnew_tx_requests\x18\x01\x20\x03\
    (\x0b2\x08.RequestR\rnewTxRequests*1\n\x08BlockTag\x12\n\n\x06Latest\x10\
    \0\x12\x0c\n\x08Earliest\x10\x01\x12\x0b\n\x07Pending\x10\x02J\xcc\x19\n\
    ...
    \x04\x01\x02\0\x12\x03\x12\x04\x13\n\r\n\x05\x04\x01\x02\0\x04\x12\x04\
    \x12\x04\x11\x12\n\x0c\n\x05\x04\x01\x02\0\x05\x12\x03\x12\x04\t\n\x0c\n\
    \x05\x04\x01\x02\0\x01\x12\x03\x12\n\x0e\n\x0c\n\x05\x04\x01\x02\0\x03\
    \x12\x03\x12\x11\x12\n\x0b\n\x04\x04\x01\x02\x01\x12\x03\x13\x04\x11\n\r\
    \n\x05\x04\x01\x02\x01\x04\x12\x04\x13\x04\x12\x13\n\x0c\n\x05\x04\x01\
    \x02\x01\x05\x12\x03\x13\x04\t\n\x0c\n\x05\x04\x01\x02\x01\x01\x12\x03\
    \x13\n\x0c\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03\x13\x0f\x10\n\x0b\n\
    ...
    \x02\x02\x03\x12\x03\x14\x12\x13\n\x0b\n\x04\x04\x01\x02\x03\x12\x03\x15\
    \x04\x13\n\r\n\x05\x04\x01\x02\x03\x04\x12\x04\x15\x04\x14\x14\n\x0c\n\
    \x05\x04\x01\x02\x03\x05\x12\x03\x15\x04\t\n\x0c\n\x05\x04\x01\x02\x03\
    \x01\x12\x03\x15\n\x0e\n\x0c\n\x05\x04\x01\x02\x03\x03\x12\x03\x15\x11\
    \x12\n\x0b\n\x04\x04\x01\x02\x04\x12\x03\x16\x04\x16\n\r\n\x05\x04\x01\
    \x02\x04\x04\x12\x04\x16\x04\x15\x13\n\x0c\n\x05\x04\x01\x02\x04\x05\x12\
    \x03\x16\x04\n\n\x0c\n\x05\x04\x01\x02\x04\x01\x12\x03\x16\x0b\x11\n\x0c\
    \n\x05\x04\x01\x02\x04\x03\x12\x03\x16\x14\x15\n\n\n\x02\x04\x02\x12\x04\
    ...
    \n\x0c\n\x04\x04\x04\x08\0\x12\x04'\x04H\x05\n\x0c\n\x05\x04\x04\x08\0\
    ...
    \x05\x04\x04\x02\x03\x01\x12\x03*\x0f\x1e\n\x0c\n\x05\x04\x04\x02\x03\
